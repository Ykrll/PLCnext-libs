// EventUtils.cpp native assembly code template.
...
bool EventUtils::init()
{
    // If necessary, insert some initialization code for the EventUtils library here!
    // Call EventUtils::init() somewhere before EventUtils::loadLibrary() is called.
...
bool EventUtils::isCompatible(const EclrVersion& requestedVersion)
{
...
bool EventUtils::load(ClrAppDomain* pAppDomain)
{
...
bool EventUtils::unload(ClrAppDomain* pAppDomain)
{
